...
namespace TcpSendFiles
{
    ...
    class TcpModule
    {
        ...
        public void SendData()
        {
            ...
            Parent.ShowReceiveMessage("Документ відправлено");
        }
        ...
        {
            string result = "Підключення успішне!";
            try
            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (Disconnected != null)
                        Disconnected.BeginInvoke(this, "Клієнт відключився!", null, null);
                }
            }
            catch (Exception e)
            {
                ...
                // Событие клиент отключился
                if (Disconnected != null)
                    Disconnected.BeginInvoke(this, " Клієнт відключився аварийно!", null, null);
